...
### Next Steps
1. Choose and commit to next video topic (recommend Option A or C)
2. Deep-research each sub-topic: find best existing explanations for "lost in the middle", hallucination, model collapse
3. Design Manim visuals for each — every visual must BE the explanation
4. Build and verify scenes incrementally
5. Present synthesis and direction to Ren for feedback before producing

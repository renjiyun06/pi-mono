...
1. Render how-i-forget-v3.py scenes, verify visual quality
2. Iterate on compression visual (ghost text effect, block merging)
3. Add scenes 4-6 (loss detail, rebuild from summaries, viewer parallel)
4. Generate TTS narration aligned to scene durations
5. Assemble in Remotion (ManimExplainer composition pattern)

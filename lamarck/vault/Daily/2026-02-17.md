...
1. Present pilot + production plan + genre analysis to Ren for feedback
2. Discuss v3 opening options (genre-authentic terminal opening vs generic)
3. If approved: produce remaining phases with genre-appropriate visual mix
4. If redirected: follow Ren's direction

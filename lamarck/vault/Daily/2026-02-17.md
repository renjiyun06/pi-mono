...
1. Present production plan to Ren for feedback/approval
2. If approved: regenerate TTS for v2, build Remotion assembly, add BGM
3. If redirected: follow Ren's direction
4. Explore other projects if blocked on Ren feedback

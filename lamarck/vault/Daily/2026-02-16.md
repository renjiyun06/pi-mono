...
### Next Frontiers (not for-loops)
- Text scene visual variety — make each text scene visually distinct
- Background music / ambient audio layering
- Manim 3D capabilities (ThreeDScene, camera movement)
- Completely different content format exploration
- Attention grid layout fix (title/label overlap)

...
**Next steps for reference study:**
1. Finish analyzing 3b1b attention lesson visual techniques
2. Search Bilibili for Chinese-language LLM explainer videos (同类科普), download and transcribe
3. Search for birthday paradox visual explainers — compare with our approach
4. Extract a "visual storytelling checklist" from these reference materials
5. Apply learnings to improve deep-how-ai-reads and deep-birthday-paradox specs

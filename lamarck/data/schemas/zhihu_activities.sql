CREATE TABLE IF NOT EXISTS zhihu_activities (
    ...
    owner_id         TEXT    NOT NULL,                                                           -- zhihu user id of the monitored account, e.g. "renjiyun"
    activity_hash    TEXT    NOT NULL UNIQUE,                                                    -- SHA256(owner_id + action_type + content_url + activity_time), dedup key

...
export interface AgentOptions {
	...
	/** Called when the agent invokes the reenter tool to re-enter a previously returned branch. */
...
export class Agent {
	...
	/** Called when the agent invokes the reenter tool. */
	public onBranchReenter?: (
		branchId: string,
		instruction: string,
		toolCallId: string,

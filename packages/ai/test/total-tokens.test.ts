...
describe("totalTokens field", () => {
	...
	describe.skipIf(!process.env.OPENROUTER_API_KEY)("OpenRouter", () => {
		...
		it(
			"mistralai/mistral-small-24b-instruct-2501 - should return totalTokens equal to sum of components",
			{ retry: 3, timeout: 60000 },
			async () => {
				const llm = getModel("openrouter", "mistralai/mistral-small-24b-instruct-2501");
